...
Populates the database with car parts and damage types
"""

from sqlalchemy.orm import Session
from database import SessionLocal, AracParcasi, HasarTipi

def populate_car_parts(db: Session):
...
def populate_damage_types(db: Session):
